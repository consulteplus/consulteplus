...
function renderCard($deal)
{
    ...
    return "
    <div class='kanban-card {$borderClass}' draggable='true' ondragstart='drag(event, {$deal['id']})' onclick=\"location.href='{$baseUrl}modules/admin/crm/detalhes.php?id={$deal['id']}'\">
        <div class='d-flex justify-content-between align-items-start'>
            ...
            <div class='dropdown' onclick='event.stopPropagation()'>
                ...
                <ul class='dropdown-menu dropdown-menu-end'>
                    <li><a class='dropdown-item' href='{$baseUrl}modules/admin/crm/detalhes.php?id={$deal['id']}'>Editar</a></li>
