    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div class="d-flex align-items-center gap-3">
                    ...
                    <?php foreach ($funis as $f): ?>
                        <li>
                            <a class="dropdown-item d-flex justify-content-between align-items-center py-2"
                                href="<?php echo BASE_URL; ?>modules/admin/crm/?view=<?php echo $view; ?>&funil=<?php echo $f['id']; ?>">
            ...
            <div class="bg-gray-200 p-1 rounded-3 d-inline-flex" style="background-color: #f3f4f6;">
                <a href="<?php echo BASE_URL; ?>modules/admin/crm/?view=quadro&funil=<?php echo $funil_id; ?>"
                ...
                <a href="<?php echo BASE_URL; ?>modules/admin/crm/?view=lista&funil=<?php echo $funil_id; ?>"
    ...
    <?php if ($view === 'quadro'): ?>
                        ...
                        <div class="task-list">
                            ...
                            foreach ($etapa['deals'] as $deal):
                                ...
                                <div class="kanban-card <?php echo $borderClass; ?>" draggable="true"
                                    ...
                                    onclick="location.href='<?php echo BASE_URL; ?>modules/admin/crm/detalhes.php?id=<?php echo $deal['id']; ?>'">
                                        ...
                                        <div class="dropdown" onclick="event.stopPropagation()">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                <li><a class="dropdown-item"
                                                        href="<?php echo BASE_URL; ?>modules/admin/crm/detalhes.php?id=<?php echo $deal['id']; ?>">Editar</a>
                                                </li>
        ...
        <script>
            function loadMoreDeals(etapaId, offset) {
                ...
                const fetchUrl = `<?php echo BASE_URL; ?>modules/admin/crm/acoes.php?acao=listar_negocios&etapa_id=${etapaId}&offset=${offset}` +
                ...
                <table class="table table-hover align-middle mb-0">
                    ...
                    <tbody>
                        <?php foreach ($res_list as $row): ?>
                            <tr onclick="location.href='<?php echo BASE_URL; ?>modules/admin/crm/detalhes.php?id=<?php echo $row['id']; ?>'"
...
<script>
    ...
    function confirmarPerdido() {
        ...
        fetch(BASE_URL + 'modules/admin/crm/acoes.php?acao=marcar_perdido', {
            method: 'POST',
    ...
    function marcarGanho(id) {
        ...
        fetch(BASE_URL + 'modules/admin/crm/acoes.php?acao=marcar_ganho', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
    ...
    if (buscaPacienteParams) {
        buscaPacienteParams.addEventListener('input', function () {
            ...
            fetch(BASE_URL + 'modules/admin/crm/acoes.php?acao=buscar_contatos&busca=' + encodeURIComponent(term) + '&tipo=user')
                .then(res => res.json())
                .then(response => {
                    list.innerHTML = '';
    ...
    if (buscaEmpresaParams) {
        buscaEmpresaParams.addEventListener('input', function () {
            ...
            fetch(BASE_URL + 'modules/admin/crm/acoes.php?acao=buscar_contatos&busca=' + encodeURIComponent(term) + '&tipo=empresa')
                .then(res => res.json())
                .then(response => {
                    list.innerHTML = '';
                    if (response.success && response.data && response.data.length > 0) {
    ...
    function salvarNegocio() {
        ...
        fetch(BASE_URL + 'modules/admin/crm/acoes.php?acao=criar_negocio', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
    ...
    function drop(ev, etapaId) {
        ...
        // Update via AJAX
        fetch(BASE_URL + 'modules/admin/crm/acoes.php?acao=mover_etapa', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
