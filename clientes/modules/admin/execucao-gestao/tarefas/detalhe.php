...
if (!$id) {
    header('Location: ' . BASE_URL . 'admin/execucao-gestao/tarefas');
    exit;
}
...
<div class="container-fluid notion-container">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div class="n-breadcrumb">
            <a href="<?php echo BASE_URL; ?>admin/execucao-gestao/tarefas">Tarefas</a>
...
<script>
    ...
    function deleteTask() {
        ...
        fetch('<?php echo BASE_URL; ?>modules/admin/execucao-gestao/tarefas/acoes.php', { method: 'POST', body: formData })
            .then(r => r.json())
            .then(d => {
                if (d.success) window.location.href = '<?php echo BASE_URL; ?>admin/execucao-gestao/tarefas';
