...
if ($historicoId === 0) {
    ...
    if ($result && $row = $result->fetch_assoc()) {
        ...
        header('Location: ' . BASE_URL . 'admin/execucao-gestao/diagnostico/novo');
        exit;
    }
}
...
<div class="container py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="<?php echo BASE_URL; ?>admin/execucao-gestao/diagnostico/resultado?id=<?php echo $historicoId; ?>"
...
<script>
    ...
    function generateAiRoadmap() {
        ...
        fetch('<?php echo BASE_URL; ?>modules/admin/execucao-gestao/diagnostico/proxy_n8n.php?type=roadmap', {
            method: 'POST',
