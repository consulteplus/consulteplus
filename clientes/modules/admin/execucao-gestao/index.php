    ...
    <div class="col-md-4">
        <div class="card h-100 border-0 shadow-sm hover-shadow transition-all">
            <div class="card-body text-center p-4">
                ...
                <a href="<?php echo BASE_URL; ?>admin/execucao-gestao/tarefas" class="btn btn-outline-primary w-100 mt-3">
        ...
        <div class="card h-100 border-0 shadow-sm hover-shadow transition-all">
            <div class="card-body text-center p-4">
                ...
                <p class="card-text text-muted small">Realize análises SWOT (Forças, Fraquezas) e PDCA para entender a
                    saúde do negócio.</p>
                <a href="<?php echo BASE_URL; ?>admin/execucao-gestao/diagnostico" class="btn btn-outline-success w-100 mt-3">
                    <i class="bi bi-arrow-right-circle me-1"></i> Acessar
                </a>
            </div>
            <div class="card-footer bg-transparent border-0 text-center pb-3">
        ...
        <div class="card h-100 border-0 shadow-sm hover-shadow transition-all">
            <div class="card-body text-center p-4">
                ...
                <p class="card-text text-muted small">Defina OKRs, metas anuais e acompanhe o progresso dos planos de
                    ação.</p>
                <a href="<?php echo BASE_URL; ?>admin/execucao-gestao/planejamento" class="btn btn-outline-info w-100 mt-3">
                    <i class="bi bi-arrow-right-circle me-1"></i> Acessar
                </a>
            </div>
            <div class="card-footer bg-transparent border-0 text-center pb-3">
