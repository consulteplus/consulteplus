...
<div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="<?php echo BASE_URL; ?>admin/execucao-gestao/projetos" class="btn btn-outline-secondary">
    ...
    <div class="row g-4">
        ...
        <div class="col-lg-8">
            <form action="<?php echo BASE_URL; ?>modules/admin/execucao-gestao/projetos/criar_manual.php" method="POST"
                id="projectForm">
...
<script>
    ...
    document.getElementById('projectForm').addEventListener('submit', async function (e) {
        ...
        try {
            const response = await fetch('<?php echo BASE_URL; ?>modules/admin/execucao-gestao/projetos/criar_manual.php', {
                method: 'POST',
            ...
            if (result.success) {
                ...
                window.location.href = '<?php echo BASE_URL; ?>admin/execucao-gestao/projetos/' + result.id;
            } else {
...
`;
        ...
        try {
            const response = await fetch('<?php echo BASE_URL; ?>modules/admin/execucao-gestao/diagnostico/proxy_n8n.php?type=project', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({
                    prompt_sistema: `
