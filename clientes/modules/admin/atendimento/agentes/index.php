...
<script>
    ...
    function carregarAgentes() {
        ...
        const url = BASE_URL + 'modules/admin/atendimento/agentes/acoes.php?acao=listar' + (tipo ? '&tipo=' + tipo : '');
    ...
    function editarAgente(id) {
        fetch(BASE_URL + 'modules/admin/atendimento/agentes/acoes.php?acao=buscar&id=' + id)
            .then(res => res.json())
            .then(response => {
    ...
    function salvarAgente() {
        ...
        fetch(BASE_URL + 'modules/admin/atendimento/agentes/acoes.php?acao=salvar', {
            method: 'POST',
    ...
    function excluirAgente(id) {
        ...
        fetch(BASE_URL + 'modules/admin/atendimento/agentes/acoes.php?acao=excluir', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
    ...
    function testarAgente(id) {
        ...
        fetch(BASE_URL + 'modules/admin/atendimento/agentes/acoes.php?acao=testar', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
