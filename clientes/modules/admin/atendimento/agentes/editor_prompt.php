...
<script>
    ...
    function carregarDados() {
        fetch(BASE_URL + 'modules/admin/atendimento/agentes/acoes.php?acao=buscar&id=' + agenteId)
            .then(res => res.json())
            .then(response => {
        ...
        fetch(BASE_URL + 'modules/admin/atendimento/agentes/acoes.php?acao=buscar&id=' + agenteId)
            ...
            .then(response => {
                if (response.success && response.data && response.data.agente) {
                    ...
                    return fetch(BASE_URL + 'modules/admin/atendimento/agentes/acoes.php?acao=salvar', {
                        method: 'POST',
...
<script>
    ...
    async function enviarSimulacao() {
        ...
        try {
            const response = await fetch(BASE_URL + 'modules/admin/atendimento/agentes/acoes.php?acao=testar_simulacao', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({
                    mensagem: texto,
