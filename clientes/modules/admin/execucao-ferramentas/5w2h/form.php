...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_GET['preview'])) {
        echo "<script>alert('Modo Simulação confirmada.'); window.location.href='" . BASE_URL . "admin/execucao-ferramentas';</script>";
        exit;
    }
    ...
    if ($stmt->execute()) {
        header("Location: " . BASE_URL . "admin/execucao-ferramentas/5w2h");
        exit;
    }
}
?>
