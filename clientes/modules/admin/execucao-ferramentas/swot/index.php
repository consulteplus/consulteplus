            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-style1 mb-1">
                    <li class="breadcrumb-item"><a
                            href="<?php echo BASE_URL; ?>admin/execucao-ferramentas">Ferramentas</a></li>
                    <li class="breadcrumb-item active">Análise SWOT</li>
                </ol>
            </nav>
            <h4 class="fw-bold mb-0">Minhas Análises SWOT</h4>
        </div>
        <a href="<?php echo BASE_URL; ?>admin/execucao-ferramentas/swot/novo" class="btn btn-primary">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card h-100 shadow-sm border-0 hover-lift">
                        <div class="card-body">
                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end">
                                        <li><a class="dropdown-item"
                                                href="<?php echo BASE_URL; ?>admin/execucao-ferramentas/swot/editar?id=<?php echo $row['id']; ?>"><i
                                                    class="bi bi-pencil me-2"></i>Editar</a></li>
                                        <li>
                                            <hr class="dropdown-divider">
                                        </li>
                                        <li><a class="dropdown-item text-danger"
                                                href="<?php echo BASE_URL; ?>admin/execucao-ferramentas/swot/excluir?id=<?php echo $row['id']; ?>"
                            ...
                            <a href="<?php echo BASE_URL; ?>admin/execucao-ferramentas/swot/editar/<?php echo $row['id']; ?>"
