...
--
-- Host: 127.0.0.1:3306
-- Tempo de geração: 26/12/2025 às 18:19
...
(99, 60, 5, 3, 3, '2025-12-26 15:00:00', 60, 'agendado', '', 400.00, 1, '2025-12-23 17:24:20', '2025-12-23 17:24:20', 0, NULL, NULL, NULL, 1, NULL, 0, 'balcao', NULL, NULL),
(100, 56, 5, 3, 3, '2025-12-26 16:00:00', 60, 'agendado', '', 400.00, 1, '2025-12-23 17:25:07', '2025-12-23 17:25:07', 0, NULL, NULL, NULL, 1, NULL, 0, 'balcao', NULL, NULL),
(101, 72, 5, 3, 3, '2025-12-26 17:00:00', 60, 'agendado', '', NULL, 1, '2025-12-23 17:27:57', '2025-12-23 17:27:57', 0, NULL, NULL, NULL, 1, NULL, 0, 'balcao', NULL, NULL),
(102, 73, 5, 3, 3, '2025-12-26 18:00:00', 60, 'agendado', '', NULL, 1, '2025-12-23 17:30:34', '2025-12-23 17:30:34', 0, NULL, NULL, NULL, 1, NULL, 0, 'balcao', NULL, NULL);
...
(4, 6, 1, 'paulo', 0, '', 'teste', 'teste', 2, 30, '2025-12-26 17:38:56', '2025-12-26 17:38:56');
...
(1, 'operacao', 'Como é feito o agendamento de consultas?', '100% Manual (Papel/Zap)', '100% Digital/Integrado', 1, '2025-12-23 20:47:33'),
(2, 'operacao', 'Existe confirmação de consultas?', 'Não confirmamos', 'Automática (SMS/Zap)', 2, '2025-12-23 20:47:33'),
(3, 'operacao', 'Como é o controle de estoque?', 'Não controlo / Olhômetro', 'Sistema com alerta de baixa', 3, '2025-12-23 20:47:33'),
(4, 'operacao', 'Há padronização no atendimento?', 'Cada um faz do seu jeito', 'Processos (POPs) claros', 4, '2025-12-23 20:47:33'),
(5, 'financeiro', 'Você sabe exatamente quanto lucrou no último mês?', 'Não faço ideia', 'Sim, centavo por centavo', 5, '2025-12-23 20:47:33'),
(6, 'financeiro', 'As contas pessoais e da clínica são separadas?', 'Tudo misturado', 'Totalmente separadas', 6, '2025-12-23 20:47:33'),
(7, 'financeiro', 'Como é feito o repasse aos profissionais?', 'Manual / Caderninho', 'Automático pelo sistema', 7, '2025-12-23 20:47:33'),
(8, 'financeiro', 'Você tem uma reserva de emergência para a clínica?', 'Não tenho', 'Sim (> 6 meses de custo)', 8, '2025-12-23 20:47:33'),
(9, 'experiencia', 'Você mede a satisfação dos pacientes (NPS)?', 'Nunca medi', 'Pesquisa recorrente automática', 9, '2025-12-23 20:47:33'),
(10, 'experiencia', 'A clínica tem presença ativa nas redes sociais?', 'Não tem / Muito pouco', 'Postagens diárias estratégicas', 10, '2025-12-23 20:47:33'),
(11, 'experiencia', 'Existe pós-venda ou contato pós-consulta?', 'O paciente vai embora e tchau', 'Sim, acompanhamento estruturado', 11, '2025-12-23 20:47:33'),
(12, 'experiencia', 'O ambiente da recepção é confortável?', 'Básico / Improvisado', 'Experiência Premium (Café, Wifi, TV)', 12, '2025-12-23 20:47:33');
...
INSERT INTO `gestao_diagnostico_resultados` (`id`, `user_id`, `data_realizacao`, `score_geral`, `score_operacao`, `score_financeiro`, `score_experiencia`, `nivel_maturidade`, `analise_ia`) VALUES
(1, 1, '2025-12-23 17:53:15', 54.00, 38.00, 56.00, 69.00, 'Em Crescimento', NULL);
...
(2, 'Treinamento da Equipe em Atendimento ao Paciente', 'Realizar treinamentos periódicos focados em melhorar o atendimento ao paciente, incluindo comunicação, empatia e resolução de conflitos, elevando a satisfação e fidelização dos clientes da clínica.', 'todo', 'alta', '2025-12-23 17:57:25', NULL, 0),
(3, 'Análise e Otimização dos Fluxos Operacionais', 'Mapear e analisar os processos internos da clínica para identificar gargalos e desperdícios, propondo melhorias que reduzam o tempo de atendimento e aumentem a produtividade da equipe.', 'todo', 'alta', '2025-12-23 17:57:25', NULL, 0),
(4, 'Campanhas de Marketing Digital e Presença Online', 'Investir em estratégias digitais como SEO, redes sociais e campanhas pagas para aumentar a visibilidade da clínica, atrair novos pacientes e fortalecer a marca no mercado local.', 'todo', 'alta', '2025-12-23 17:57:25', NULL, 0),
(5, 'Implementação de Pesquisas de Satisfação', 'Criar um sistema regular de coleta de feedback dos pacientes através de pesquisas de satisfação para identificar pontos fortes e oportunidades de melhoria na clínica.', 'todo', 'alta', '2025-12-23 17:57:25', NULL, 0);
