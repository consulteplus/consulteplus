                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6 text-md-end mt-3 mt-md-0">
                        <div class="d-flex justify-content-md-end gap-2">
                            <a href="<?php echo BASE_URL; ?>gestao/projetos/novo"
                                class="btn btn-outline-primary fw-semibold">
                                <i class="bi bi-plus-lg me-2"></i>Novo
                            </a>
                            <a href="<?php echo BASE_URL; ?>gestao/diagnostico/novo"
                ...
                <div class="card border-0 shadow-sm">
                    <div class="card-body text-center py-5 px-4">
                        ...
                        <div class="d-grid gap-2 d-sm-flex justify-content-sm-center">
                            ...
                            <a href="<?php echo BASE_URL; ?>gestao/diagnostico/novo" class="btn btn-primary px-4">
...
`;
        ...
        fetch('<?php echo BASE_URL; ?>modules/gestao/diagnostico/proxy_n8n.php?type=project', {
            method: 'POST',
    ...
    document.getElementById('formNewProject').addEventListener('submit', function (e) {
        ...
        fetch('<?php echo BASE_URL; ?>modules/gestao/projetos/criar_manual.php', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
            ...
            .then(d => {
                if (d.success) {
                    window.location.href = '<?php echo BASE_URL; ?>gestao/projetos/detalhe.php?id=' + d.id;
                } else {
