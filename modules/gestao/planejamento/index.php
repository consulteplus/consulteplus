...
<script>
    ...
    document.getElementById('formObjetivo').addEventListener('submit', function (e) {
        e.preventDefault();
        fetch(BASE_URL + 'modules/gestao/planejamento/acoes.php', { method: 'POST', body: new FormData(this) })
            .then(r => r.json())
    ...
    function updateKrValue(id, value, objId) {
        ...
        fetch(BASE_URL + 'modules/gestao/planejamento/acoes.php', { method: 'POST', body: fd })
            .then(r => r.json())
            .then(d => {
                if (d.success) {
