                    ...
                    <div class="col-md-8">
                        <div class="row g-2 align-items-center justify-content-end">
                            ...
                            <div class="col-auto">
                                <div class="view-switcher d-none d-lg-inline-flex">
                                    <button class="view-btn active" onclick="switchView('kanban')"><i class="bi bi-kanban me-1"></i> Quadro</button>
                                    <button class="view-btn" onclick="switchView('lista')"><i class="bi bi-list-ul me-1"></i> Lista</button>
                                    <button class="view-btn" onclick="switchView('calendario')"><i class="bi bi-calendar3 me-1"></i> Calendário</button>
                                </div>
                            </div>
                            ...
                            <div class="col-auto">
                                <div class="input-group input-group-sm border rounded bg-white" style="width: 140px;">
                                    ...
                                    <input type="text" class="form-control border-0 ps-1 shadow-none" id="searchInput" placeholder="Buscar..." onkeyup="filterTasks()">
                                </div>
                            </div>
                            ...
                            <div class="col-auto">
                                <div class="dropdown">
                                    <button class="btn btn-white border shadow-sm btn-sm px-3 d-flex align-items-center fw-500 text-secondary" type="button" data-bs-toggle="dropdown" aria-expanded="false" style="height: 38px;">
                                        <i class="bi bi-funnel me-2"></i> Filtrar
                                    </button>
                                    <div class="dropdown-menu p-3 shadow-sm border-0 dropdown-menu-end" style="width: 280px;">
                                        <h6 class="dropdown-header text-uppercase small fw-bold mb-2 ps-0 text-muted" style="letter-spacing: 0.5px;">Adicionar Filtro</h6>
                                        <div class="mb-3">
                                            <label class="form-label small text-secondary fw-bold mb-1">Status</label>
                                            <select class="form-select form-select-sm bg-light border-0" id="filterStatus" onchange="filterTasks()">
                                        ...
                                        <div class="mb-3">
                                            <label class="form-label small text-secondary fw-bold mb-1">Prioridade</label>
                                            <select class="form-select form-select-sm bg-light border-0" id="filterPriority" onchange="filterTasks()">
                                        ...
                                        <div class="mb-1">
                                            ...
                                            <select class="form-select form-select-sm bg-light border-0" id="filterProject" onchange="filterTasks()">
                                                <option value="all">Todos</option>
                            ...
                            <!-- Nova Button -->
                            <div class="col-auto">
                                <button class="btn btn-dark btn-sm px-3 shadow-sm d-flex align-items-center fw-bold text-nowrap" style="height: 38px;" data-bs-toggle="modal" data-bs-target="#modalNovaTarefa">
                        ...
                        <div class="d-lg-none mt-3">
                            <div class="view-switcher w-100 justify-content-between">
                                <button class="view-btn flex-fill text-center active" onclick="switchView('kanban')"><i class="bi bi-kanban"></i></button>
                                <button class="view-btn flex-fill text-center" onclick="switchView('lista')"><i class="bi bi-list-ul"></i></button>
                                <button class="view-btn flex-fill text-center" onclick="switchView('calendario')"><i class="bi bi-calendar3"></i></button>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <tbody>
                        <?php foreach ($allTasks as $t):
                            ...
                            <tr class="task-table-row"
                                onclick="location.href='<?php echo BASE_URL; ?>gestao/tarefas/<?php echo $t['id']; ?>'">
...
function renderTask($task)
{
    ...
    <div class="kanban-task" id="task-' . $task['id'] . '" draggable="true" ondragstart="drag(event)"
         ...
         onclick="location.href=\'' . BASE_URL . 'gestao/tarefas/' . $task['id'] . '\'">
    ...
    function initCalendar() {
        ...
        foreach ($allTasks as $t) {
            ...
            $events[] = [
                ...
                'color' => $color,
                'url' => BASE_URL . 'gestao/tarefas/' . $t['id'],
                'extendedProps' => [
...
`;
        ...
        fetch('<?php echo BASE_URL; ?>modules/gestao/diagnostico/proxy_n8n.php?type=task', {
            method: 'POST',
