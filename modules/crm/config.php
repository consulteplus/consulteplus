...
<script>
    ...
    function salvarOrdemEtapas(funilId, ordemArray) {
        fetch(BASE_URL + 'crm/acoes?acao=reordenar_etapas', {
            method: 'POST',
    ...
    function salvarFunil() {
        ...
        fetch(BASE_URL + 'crm/acoes?acao=' + acao, {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
    ...
    function excluirFunil(id) {
        ...
        fetch(BASE_URL + 'crm/acoes?acao=excluir_funil', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
    ...
    function excluirEtapa(id) {
        ...
        fetch(BASE_URL + 'crm/acoes?acao=excluir_etapa', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
            body: JSON.stringify({ id })
        })
