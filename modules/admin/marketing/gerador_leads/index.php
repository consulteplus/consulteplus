...
<script>
    ...
    function salvarConfig() {
        ...
        fetch(BASE_URL + 'modules/admin/marketing/gerador_leads/acoes.php?acao=salvar_config', {
            method: 'POST',
    ...
    function iniciarScraping(source) {
        ...
        fetch(BASE_URL + 'modules/admin/marketing/gerador_leads/acoes.php?acao=trigger_scraping', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
    ...
    function conectarWhatsapp() {
        ...
        // 1. Iniciar Conexão
        fetch(BASE_URL + 'modules/admin/marketing/gerador_leads/api_whatsapp.php?action=connect')
            .then(r => r.json())
            .then(res => {
                if (res.success) {
    ...
    function verificarStatus() {
        ...
        fetch(BASE_URL + 'modules/admin/marketing/gerador_leads/api_whatsapp.php?action=status')
            .then(r => r.json())
            .then(res => {
    ...
    function desconectarWhatsapp() {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                Swal.showLoading();
                fetch(BASE_URL + 'modules/admin/marketing/gerador_leads/api_whatsapp.php?action=logout', { method: 'DELETE' })
                    .then(r => r.json())
                    .then(res => {
                        if (res.success) {
    ...
    function listarGrupos() {
        ...
        fetch(BASE_URL + 'modules/admin/marketing/gerador_leads/api_whatsapp.php?action=list_groups')
            .then(r => r.json())
            .then(res => {
    ...
    function extrairContatos(groupId, groupName) {
        Swal.fire({
            ...
            preConfirm: () => {
                return fetch(BASE_URL + 'modules/admin/marketing/gerador_leads/acoes.php?acao=extrair_whatsapp', {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json' },
    ...
    document.addEventListener('DOMContentLoaded', function () {
        tabelaResultados = $('#tabelaResultados').DataTable({
            ...
            ajax: BASE_URL + 'modules/admin/marketing/gerador_leads/acoes.php?acao=listar_resultados',
            columns: [
                {
                    data: 'id',
    ...
    function processarAcao(ids, tipo) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                fetch(BASE_URL + 'modules/admin/marketing/gerador_leads/acoes.php?acao=processar_leads', {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json' },
