...
<script>
    ...
    function salvarOrdemEtapas(funilId, ordemArray) {
        fetch(BASE_URL + 'modules/admin/crm/acoes.php?acao=reordenar_etapas', {
            method: 'POST',
    ...
    function salvarFunil() {
        ...
        fetch(BASE_URL + 'modules/admin/crm/acoes.php?acao=' + acao, {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
    ...
    function excluirFunil(id) {
        ...
        fetch(BASE_URL + 'modules/admin/crm/acoes.php?acao=excluir_funil', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
    ...
    function excluirEtapa(id) {
        ...
        fetch(BASE_URL + 'modules/admin/crm/acoes.php?acao=excluir_etapa', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
            body: JSON.stringify({ id })
        })
