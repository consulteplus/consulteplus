...
<head>
    ...
    <!-- Custom CSS -->
    <link rel="stylesheet" href="<?php echo BASE_URL; ?>assets/css/style.css?v=2.3.0">
    <link rel="stylesheet" href="<?php echo BASE_URL; ?>assets/css/custom.css?v=2.3.0">
    <link rel="stylesheet" href="<?php echo BASE_URL; ?>assets/css/custom-override.css?v=2.3.0">
    <link rel="stylesheet" href="<?php echo BASE_URL; ?>assets/css/custom-modern-sidebar.css?v=2.5.7">
    <link rel="stylesheet" href="<?php echo BASE_URL; ?>assets/css/tour.css?v=2.3.0">
    <link rel="stylesheet" href="<?php echo BASE_URL; ?>assets/css/modules.css?v=2.6.2">
</head>
